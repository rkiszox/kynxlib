...
function kynx:MakeWindow(Configs)
	...
	if WLocked then
		...
		local LockText = Create("TextLabel", MainFrame, {
	...
	local Title = InsertTheme(Create("TextLabel", TitleHolder, {
		...
		Font = Enum.Font.IndieFlower, Name = "Title"
	}), "Text")
	...
	if WLocked then
		local LockText2 = Create("TextLabel", Containers, {
			Size = UDim2.new(1, 0, 0, 20),
			Position = UDim2.new(0.5, 0, 0.5, 0),
			AnchorPoint = Vector2.new(0.5, 0.5),
			BackgroundTransparency = 1,
	...
	function Window:CloseBtn()
		...
		local DText = Create("TextLabel", DialogFrame, {
			...
			Text = "Do you want to close the ui?", TextXAlignment = "Center",
	...
	function Window:MakeTab(paste, Configs)
		...
		if TLocked then
			local LockText2 = Create("TextLabel", Container, {
				Size = UDim2.new(1, 0, 0, 20),
				Position = UDim2.new(0.5, 0, 0.5, 0),
				AnchorPoint = Vector2.new(0.5, 0.5),
				BackgroundTransparency = 1,
		...
		function Tab:AddTextBox(Configs)
			...
			if TLocked then
				...
				TextBoxInput.TextColor3 = Theme["Color Dark Text"]
