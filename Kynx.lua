...
local kynx = {
	Themes = {
		Darker = {
			...
			["Color Hub 2"] = Color3.fromRGB(26, 26, 32),
			["Color Stroke"] = Color3.fromRGB(45, 45, 55),
			["Color Theme"] = Color3.fromRGB(108, 92, 255),
			["Color Text"] = Color3.fromRGB(248, 248, 255),
			["Color Dark Text"] = Color3.fromRGB(168, 172, 188)
		},
		Dark = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(32, 32, 38)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(40, 40, 48)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(32, 32, 38))
			}),
			["Color Hub 2"] = Color3.fromRGB(40, 40, 48),
			["Color Stroke"] = Color3.fromRGB(58, 58, 68),
			["Color Theme"] = Color3.fromRGB(80, 165, 255),
			["Color Text"] = Color3.fromRGB(252, 252, 255),
			["Color Dark Text"] = Color3.fromRGB(178, 182, 198)
		},
		Purple = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(28, 22, 35)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(36, 28, 45)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(28, 22, 35))
			}),
			["Color Hub 2"] = Color3.fromRGB(36, 28, 45),
			["Color Stroke"] = Color3.fromRGB(55, 45, 65),
			["Color Theme"] = Color3.fromRGB(190, 70, 255),
			["Color Text"] = Color3.fromRGB(248, 242, 255),
			["Color Dark Text"] = Color3.fromRGB(180, 168, 195)
		}
	},
	Info = {Version = "1.1.0"},
...
function kynx:MakeWindow(Configs)
	...
	local MainCorner = Make("Corner", MainFrame, UDim.new(0, 14))
	local Components = Create("Folder", MainFrame, {Name = "Components"})
	local DropdownHolder = Create("Folder", ScreenGui, {Name = "Dropdown"})
	local TopBar = Create("Frame", Components, {Size = UDim2.new(1, 0, 0, 44), BackgroundTransparency = 1, Name = "Top Bar"})
	...
	local Title = InsertTheme(Create("TextLabel", TitleHolder, {
		Position = UDim2.new(0, 0, 0, 2), AnchorPoint = Vector2.new(0, 0), AutomaticSize = "XY",
		Text = WTitle, TextXAlignment = "Left", TextSize = 14,
	...
	local SubTitle = InsertTheme(Create("TextLabel", TitleHolder, {
		Position = UDim2.new(0, 0, 0, 15), AnchorPoint = Vector2.new(0, 0), AutomaticSize = "XY",
	...
	function Window:Dialog(Configs)
		...
		local Screen = InsertTheme(Create("Frame", MainFrame, {
			...
			BackgroundColor3 = Theme["Color Stroke"], Name = "Dialog"
		}), "Stroke")
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddSection(Configs)
			...
			local SectionLabel = InsertTheme(Create("TextLabel", SectionFrame, {
				...
				BackgroundTransparency = 1, TextTruncate = "AtEnd", TextSize = 14,
				TextXAlignment = "Left"
			}), "Text")
			local Section = {}
		...
		function Tab:AddToggle(Configs)
			...
			local ToggleGlow = InsertTheme(Create("Frame", Toggle, {
				Size = UDim2.new(2, 0, 2, 0), Position = UDim2.new(0.5, 0, 0.5, 0),
				AnchorPoint = Vector2.new(0.5, 0.5), BackgroundColor3 = Theme["Color Theme"],
				BackgroundTransparency = 0.6
			}), "Theme")Make("Corner", ToggleGlow, UDim.new(0.5, 0))
			local WaitClick
			local function SetToggle(Val)
				...
				if Default then
					...
					CreateTween({ToggleGlow, "BackgroundTransparency", 0.3, 0.25})
				else
					CreateTween({Toggle, "Position", UDim2.new(0, 0, 0.5), 0.25})
					CreateTween({Toggle, "BackgroundTransparency", 0.8, 0.25})
					CreateTween({Toggle, "AnchorPoint", Vector2.new(0, 0.5), 0.25, Wait or false})
					CreateTween({ToggleGlow, "BackgroundTransparency", 0.6, 0.25})
				end
				WaitClick = false
		...
		function Tab:AddDropdown(Configs)
			...
			local ScrollFrame = InsertTheme(Create("ScrollingFrame", DropFrame, {
				...
				ScrollBarThickness = 1.5, BackgroundTransparency = 1, BorderSizePixel = 0,
		...
		function Tab:AddSlider(Configs)
			...
			}), "Stroke")Make("Corner", SliderBar, UDim.new(0, 4))
			local Indicator = InsertTheme(Create("Frame", SliderBar, {
				BackgroundColor3 = Theme["Color Theme"], Size = UDim2.fromScale(0.3, 1),
				BorderSizePixel = 0
			}), "Theme")Make("Corner", Indicator, UDim.new(0, 4))
			local SliderIcon = Create("Frame", SliderBar, {
				Size = UDim2.new(0, 8, 0, 16), BackgroundColor3 = Color3.fromRGB(235, 235, 240),
				Position = UDim2.fromScale(0.3, 0.5), AnchorPoint = Vector2.new(0.5, 0.5),
				BackgroundTransparency = 0
			})Make("Corner", SliderIcon, UDim.new(0.5, 0))
			local Glow = InsertTheme(Create("Frame", SliderIcon, {
				Size = UDim2.new(2.5, 0, 2.5, 0), Position = UDim2.new(0.5, 0, 0.5, 0),
				AnchorPoint = Vector2.new(0.5, 0.5), BackgroundColor3 = Theme["Color Theme"],
				BackgroundTransparency = 0.5
			}), "Theme")Make("Corner", Glow, UDim.new(0.5, 0))
			...
			SliderHolder.MouseButton1Down:Connect(function()
				...
				CreateTween({Glow, "BackgroundTransparency", 0.2, 0.3})
				Container.ScrollingEnabled = false
				while UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) do task.wait()
					ControlPos()
				end
				CreateTween({SliderIcon, "Transparency", 0, 0.3})
				CreateTween({Glow, "BackgroundTransparency", 0.5, 0.3})
