...
local function ButtonFrame(Instance, Title, Description, HolderSize, Icon)
...
function kynx:MakeWindow(Configs)
	...
	if not WLocked then MakeDrag(MainFrame) end
	...
	local Title = InsertTheme(Create("TextLabel", TitleHolder, {
		Position = UDim2.new((WIcon and WIcon:find("rbxassetid://") and 22 or 0), 0, 0, 2), AnchorPoint = Vector2.new(0, 0), AutomaticSize = "XY",
	...
	local SubTitle = InsertTheme(Create("TextLabel", TitleHolder, {
		Position = UDim2.new((WIcon and WIcon:find("rbxassetid://") and 22 or 0), 0, 0, 20), AnchorPoint = Vector2.new(0, 0), AutomaticSize = "XY",
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddParagraph(Configs)
			...
			if PIcon and PIcon:find("rbxassetid://") then
				local IconImage = Create("ImageLabel", Frame, {
					Size = UDim2.new(0, 16, 0, 16),
					Position = UDim2.new(1, -12, 0.5),
					AnchorPoint = Vector2.new(1, 0.5),
		...
		function Tab:AddButton(Configs)
			...
			local FButton, LabelFunc = ButtonFrame(Container, BName, BDescription, UDim2.new(1, -20), BIcon)
			if BLocked then
				FButton.BackgroundTransparency = 0.2
