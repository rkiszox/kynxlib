	...
	Themes = {
		Light = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(245, 245, 250)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(250, 250, 255)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(245, 245, 250))
			}),
			["Color Hub 2"] = Color3.fromRGB(248, 248, 252),
			["Color Stroke"] = Color3.fromRGB(220, 220, 230),
			["Color Theme"] = Color3.fromRGB(60, 60, 70),
			["Color Text"] = Color3.fromRGB(20, 20, 25),
			["Color Dark Text"] = Color3.fromRGB(120, 120, 130)
		}
	},
	Info = {Version = "1.0.0"},
	Save = {UISize = {550, 380}, TabSize = 160, Theme = "Light"},
	Settings = {},
	Connection = {},
	Instances = {},
	Elements = {},
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddButton(Configs)
			...
			local ButtonIcon = Create("ImageLabel", FButton, {
				Size = UDim2.new(0, 16, 0, 16), Position = UDim2.new(1, -12, 0.5),
				AnchorPoint = Vector2.new(1, 0.5), BackgroundTransparency = 1,
		...
		function Tab:AddToggle(Configs)
			...
			local ToggleHolder = InsertTheme(Create("Frame", Button, {
				Size = UDim2.new(0, 42, 0, 22), Position = UDim2.new(1, -10, 0.5),
		...
		function Tab:AddSlider(Configs)
			...
			local SliderIcon = Create("Frame", SliderBar, {
				Size = UDim2.new(0, 14, 0, 14), BackgroundColor3 = Color3.fromRGB(60, 60, 70),
		...
		function Tab:AddTextBox(Configs)
			...
			local TClearText = Configs[3] or Configs.ClearText or false			local Callback = Funcs:GetCallback(Configs, 4)
